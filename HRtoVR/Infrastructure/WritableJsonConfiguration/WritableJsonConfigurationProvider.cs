...
namespace HRtoVR.Infrastructure.WritableJsonConfiguration;
...
public class WritableJsonConfigurationProvider : JsonConfigurationProvider {
    ...
    private void Save(JsonNode jsonObj) {
        ...
        var fileFullPath = fileProvider.GetFileInfo(path).PhysicalPath ??
                           throw new InvalidOperationException("Physical path could not be determined.");
    ...
    public void Set(string key, object value) {
        ...
        var jsonNode =
            JsonNode.Parse(serialized) ?? JsonValue.Create(value); // Преобразуем сериализованное значение в JsonNode
