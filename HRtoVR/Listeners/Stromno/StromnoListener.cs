...
namespace HRtoVR.Listeners.Stromno;

public class StromnoListener : PulsoidListener {
    private readonly IOptionsMonitor<StromnoOptions> _stromnoOptions;

    public StromnoListener(ILogger<StromnoListener> logger, IOptionsMonitor<StromnoOptions> options,
        IOptionsMonitor<PulsoidOptions> pulsoidOptions) : base(logger, pulsoidOptions) {
