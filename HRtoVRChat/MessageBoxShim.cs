...
namespace MessageBox.Avalonia
{
    ...
    {
        public static HRtoVRChat.IMsBoxWindow<Enums.ButtonResult> GetMessageBoxStandardWindow(DTO.MessageBoxStandardParams parameters)
        {
...
namespace MessageBox.Avalonia.DTO
{
    ...
    {
        public Enums.ButtonEnum ButtonDefinitions { get; set; } = Enums.ButtonEnum.Ok;
        ...
        public Enums.Icon Icon { get; set; } = Enums.Icon.None;
